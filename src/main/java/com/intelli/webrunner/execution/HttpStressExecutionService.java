...
public final class HttpStressExecutionService {
	...
	public ExecutionResult execute(
		...
		try {
			...
			while (!Thread.currentThread().isInterrupted() && counters.scheduled.get() < limit && System.currentTimeMillis() < deadline) {
			...
			while (!Thread.currentThread().isInterrupted() && counters.completed.get() < counters.scheduled.get()) {
